...
public class AssetInstallationResponse {
    ...
    public boolean equals(Object o) {
        ...
        AssetInstallationResponse that = (AssetInstallationResponse) o;
    ...
    public String toString() {
        return "AssetInstallationResponse{" + "message=" + message + ", errorData='" + errorData + '\'' + '}';
    }
}
